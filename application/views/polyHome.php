        ...
        <div id="controls" style="display:block; height:70px">
            <div class="toppanel">
              <form class = "navbar-form pull-left" name="filterForm2">
                    <div class="center"><p>Filter Incidents:</p>   
                        <select class="multiselect1" multiple = "multiple" name="filterMenu2" onChange="filterReports()">
            ...
            <div class="toppanel">
                <form class = "navbar-form pull-left" name="filterForm1">
                    <div class="center"><p>View Incidents by:</p>   
                            <select multiple = "multiple" class="multiselect" data-role = "multiselect" name="filterMenu1" onChange="filterReports()">
  ...
  <div class = "container-fluid">
        ...
        <div id= "panell" class="panell" style="height: 95%;">
          <!-- BREADCRUMBS -->
...
<div id= "map_canvass">
    <div id="map_canvas" style="top:100px; width:100%; height:595px;"></div>   
</div>
